          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-400">Search for "networking" and find sections about "making friends" and "meeting people" - the AI understands concepts, not just words.</p>
              </div>
            </div>
